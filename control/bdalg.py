...
def lft(sys1, sys2, nu=-1, ny=-1, **kwargs):
    ...
    ny : int, optional
        ...
        the number of inputs of `sys2`.  If not specified, defaults
        to the largest value allowed by the shapes of `sys1` and
        `sys2`.
    nu : int, optional
        Dimension of (plant) control input that is generated by
        `sys2`.  Must not exceed the number of inputs of `sys1` or
        the number of outputs of `sys2`.  If not specified, defaults
        to the largest value allowed by the shapes of `sys1` and
        `sys2`.
